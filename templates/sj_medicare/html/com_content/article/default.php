...
<?php  if (isset($images->image_fulltext) and !empty($images->image_fulltext)) {    
        $pageclassex = 'item-page-with-img';
    } else {
        $pageclassex = '';
    } 
?>
<div class="item-page <?php echo $pageclassex; ?> <?php echo $this->pageclass_sfx; ?>" itemscope itemtype="http://schema.org/Article">
    ...
    <div class="img-fulltext pull-<?php echo htmlspecialchars($imgfloat); ?>">
        <a href="<?php echo $images->image_fulltext; ?>" title="<?php echo htmlspecialchars($images->image_fulltext_alt); ?>" class="modal">
            <?php echo $thumb_img; ?>
        </a>
