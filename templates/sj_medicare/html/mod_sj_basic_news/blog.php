...
?>
	...
	<div id="<?php echo $uniquied?>" class="sj-basic-news">
		<div class="bs-item row">
			...
			?>
			<div class="item col-md-4 <?php echo $show_line.' '.$last_class; ?>">
                <div class="item-wrap">
				<?php if($img){?>
				<div class="bs-image">
					<a class="item-img" href="<?php echo $item->link ?>" title="<?php echo $item->title; ?>" <?php echo SjBasicNewsHelper::parseTarget($params->get('link_target')); ?>>
						<?php
				...
				<div class="bs-content">
					...
					<div class="bs-cat-date">
                        ...
                        <?php echo  JHTML::_('date', $item->created,JText::_('M d, Y')) ;?>.</span>
                        <?php echo 'by'; ?>
