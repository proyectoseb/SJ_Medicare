...
?>
	...
	<div id="<?php echo $uniquied?>" class="sj-basic-news">
		<div class="row bs-items">
			...
			?>
			<div class="col-md-4 col-sm-4"><div class="bs-item cf <?php echo $show_line.' '.$last_class; ?>">
				<?php if($img){?>
				<div class="bs-image">
				...
				<div class="bs-content">
					...
					<div class="bs-info">
						<?php if($params->get('item_date_display') == 1 ){?>
						  <span class="bs-date" data-author="<?php echo  $item->author ;?>"><i class="fa fa-clock-o"></i><?php echo JText::sprintf( JHtml::_('date', $item->created, JText::_('d M Y'))); ?></span>
						<?php }?>
                        <span class="bs-author"><i class="fa fa-user"></i><?php echo  $item->author; ?></span>
					</div>
