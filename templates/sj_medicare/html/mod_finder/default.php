...
$output = '<input type="text" name="q" id="mod-finder-searchword" class="search-query input-medium" size="' . $params->get('field_size', 20) . '" placeholder="' . $params->get('alt_label', JText::_('JSEARCH_FILTER_SUBMIT')) . '" />';
...
{
    $button = '<button type="submit" title="' . JText::_('MOD_FINDER_SEARCH_BUTTON') . '"><span class="icon-search icon-white"></span></button>';
