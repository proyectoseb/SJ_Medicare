	...
	jQuery(document).ready(function ($) {
		...
		(function (element) {
			...
			function checkFormValidationState() {
				...
				check_valid = nameValid && emailValid && subjectValid && dateValid; //&& messageValid 
				<?php } else {
					if($captcha_type == 1) { ?>
				check_valid = nameValid && emailValid && subjectValid && dateValid && captchaValid;//&& messageValid 
				<?php } else { ?>
				check_valid = nameValid && emailValid && subjectValid && dateValid;//&& messageValid 
				<?php } ?>
				<?php }
			...
			$form.on('submit', function () {
				...
				$check_empty = $name_value == '' || $subject_value == '' || $email_value == '' || $date_value == '';//|| $message_value == '' 
				<?php } else {
					if($captcha_disable == 1 && $user->id != 0  ){ ?>
				$check_empty = $name_value == '' || $subject_value == '' || $email_value == '' || $date_value == '';//|| $message_value == '' 
				<?php }else{
					if($captcha_type == 1) { ?>
				$check_empty = $name_value == '' || $subject_value == '' || $email_value == '' || $date_value == '' || $captcha_value == '';//|| $message_value == '' 
				<?php } else { ?>
				var $recaptcha_value = Recaptcha.get_response();
				$check_empty = $name_value == '' || $subject_value == '' || $email_value == '' || $date_value == '' || $recaptcha_value == '';//|| $message_value == '' 
				<?php	}
				 }
			 } ?>
