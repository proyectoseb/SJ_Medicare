	...
	jQuery(document).ready(function ($) {
		...
		(function (element) {
			...
			function checkFormValidationState() {
				...
				<?php } else {
					if($captcha_type == 1) { ?>
				check_valid = nameValid && emailValid && subjectValid && messageValid && captchaValid; //&& dateValid ;
				<?php } else { ?>
				check_valid = nameValid && emailValid && subjectValid && messageValid; //&& dateValid;
				<?php } ?>
				<?php }
			...
			$form.on('submit', function () {
				...
				<?php }else{
					if($captcha_type == 1) { ?>
				$check_empty = $name_value == '' || $subject_value == '' || $email_value == '' || $message_value == '' || $captcha_value == '';// || $date_value == '' ;
				<?php } else { ?>
				var $recaptcha_value = Recaptcha.get_response();
				$check_empty = $name_value == '' || $subject_value == '' || $email_value == '' || $message_value == ''  || $recaptcha_value == ''; //|| $date_value == '';
				<?php	}
				 }
			 } ?>
