				...
				<div class="el-inner cf">
					<div class="el-form cf">
						<form class="el-ctajax-form" id="el_ctajax_form" method="post" action="#">
							...
							<div class="el-control">
								<label for="cainput_subject"><?php echo JText::_('PHONE_LABEL'); ?></label>
								<input type="text" autocomplete="off" name="cainput_subject" class="el-input" id="cainput_subject"
                                       placeholder="<?php echo JText::_('PHONE_LABEL'); ?>">
							<span class="ca-tooltip" title="" data-toggle="tooltip"
							      data-original-title="<?php echo JText::_('PHONE_ERROR'); ?>">
								<i class="icon-exclamation-sign el-error"></i>
							</span>
								<i class="icon-ok-sign el-ok"></i>
                                <div class="clr"></div>
                            ...
                            <div class="row">
							<div class="el-control col-md-8 col-xs-12">
								<label for="cainput_date"><?php echo JText::_('DATE_LABEL'); ?></label>
								<input type="text" autocomplete="off" name="cainput_date" class="el-input el-input-date" id="cainput_date"
                            ...
                            <div class="el-control col-md-4 col-xs-12">
								<input type="submit" value="<?php echo JText::_('SEND_MAIL_LABEL2'); ?>" id="cainput_submit">
