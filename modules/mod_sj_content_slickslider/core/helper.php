...
class ContentSlickSliderHelper extends ContentSlickSliderBaseHelper {
	...
	// 		// New Parameters
		...
		// Prepare data for display using display options
			foreach ($items as &$item)
			{
				...
				if ($show_introtext) {
					$item->introtext = JHtml::_('content.prepare', $item->introtext, '', 'mod_sj_content_slickslider.content');
